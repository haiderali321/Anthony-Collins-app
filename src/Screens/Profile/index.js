            ...
            <View style={styles.containerC2}>
                ...
                <TouchableOpacity style={styles.options}>
                    <View>
                        ...
                        <Text style={styles.text}>amytan@email.com</Text>
                    </View>
                </TouchableOpacity>
                <TouchableOpacity style={styles.options}>
                    <View>
                ...
                <TouchableOpacity style={styles.options}>
                    <View>
                        ...
                        <Text style={styles.text}>43062</Text>
                    </View>
                </TouchableOpacity>
                <TouchableOpacity style={styles.options}>
                    <View>
                        <Text style={styles.smallText}>Phone number</Text>
                        <Text style={styles.text}>(321) 883-3110</Text>
                    </View>
                </TouchableOpacity>
            </View>
            <View style={styles.containerC3}>
                <TouchableOpacity style={styles.submitButton} onPress={() => navigation.navigate('EditProfile')}>
                    <Text style={styles.submitButton_Text}>Edit</Text>
                </TouchableOpacity>
            </View>
        </View>
    );
